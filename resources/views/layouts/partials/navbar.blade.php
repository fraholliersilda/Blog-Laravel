        ...
        <ul class="navbar-nav ms-auto">
            ...
            {{-- <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('backend/dist/assets/img/user1-128x128.jpg') }}" alt="User Avatar"
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('backend/dist/assets/img/user8-128x128.jpg') }}" alt="User Avatar"
                                    class="img-size-50 rounded-circle me-3" />
                            </div>
                            <div class="flex-grow-1">
                                <h3 class="dropdown-item-title">
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0">
                                <img src="{{ asset('backend/dist/assets/img/user3-128x128.jpg') }}" alt="User Avatar"
                                    class="img-size-50 rounded-circle me-3" />
                            </div>
                            <div class="flex-grow-1">
                                <h3 class="dropdown-item-title">
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu dropdown-menu-end">
                    <!--begin::User Image-->
                    {{-- <li class="user-header text"> --}}
                    {{-- <img src="
                        {{ asset('backend/dist/assets/img/user2-160x160.jpg') }}
                         "
